    ...
    return (
        <div style={{ padding: '2rem', backgroundColor: 'var(--background-color)', fontFamily: 'Roboto, sans-serif', color: 'var(--main-text-color)', maxWidth: '900px', margin: 'auto', borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }}>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <Image src="/path/to/homepage-screenshot.jpg" alt="Homepage Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
            </section>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <Image src="/path/to/register-login-screenshot.jpg" alt="Register and Login Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
            </section>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <Image src="/path/to/homepage-overview-screenshot.jpg" alt="Homepage Overview Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
            </section>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <Image src="/path/to/search-page-screenshot.jpg" alt="Search Page Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
                ...
                <Image src="/path/to/series-details-screenshot.jpg" alt="Series Details Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
            </section>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <Image src="/path/to/mylist-screenshot.jpg" alt="MyList Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
            </section>
            ...
            <section style={{ marginBottom: '2rem' }}>
                ...
                <Image src="/path/to/profile-settings-screenshot.jpg" alt="Profile Settings Screenshot" width={1000} height={500} style={{ borderRadius: '8px', boxShadow: '0 0 10px rgba(0, 0, 0, 0.1)' }} />
            </section>
